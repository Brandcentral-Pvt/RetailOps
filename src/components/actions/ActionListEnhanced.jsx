...
const ReviewRemarkPopover = ({ id, status, comments }) => {
    return (
        <Popover
            ...
            content={
                <div>
                    <div className={`fw-bold mb-1 ${status === 'REJECTED' ? 'text-danger' : 'text-success'}`} style={{ fontSize: 'var(--font-size-xs)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
        ...
        >
            <div className="d-flex align-items-center" style={{ cursor: 'pointer' }}>
                <span
                    ...
                    style={{ maxWidth: '150px', fontSize: 'var(--font-size-xs)', textDecoration: 'underline dotted', fontWeight: 600 }}
                >
...
const AutoGeneratedSubTable = ({ action }) => {
    ...
    return (
        <div className="p-3" style={{ backgroundColor: '#f8fafc', boxShadow: 'inset 0 4px 6px -4px rgba(0, 0, 0, 0.05)', borderBottom: '1px solid #e2e8f0' }}>
            <h6 className="mb-3 d-flex align-items-center gap-2" style={{ fontSize: '0.85rem', fontWeight: 600, color: '#1976D2' }}>
            ...
            <div className="smartsheet-container mt-4" style={{ overflow: 'auto' }}>
                            ...
                            if (type === 'DIVIDER') {
                                return (
                                    <tr key={row.id} style={{ background: 'var(--color-brand-50)', borderTop: '2px solid var(--color-brand-600)', borderBottom: '1px solid var(--color-brand-200)' }}>
                                        <td colSpan={9} style={{ padding: '8px 16px', fontWeight: 600, color: 'var(--color-brand-600)', fontSize: '0.82rem', letterSpacing: '0.03em' }}>
                                            {data.label}
                                        </td>
                                    </tr>
                                );
                                        ...
                                        <td>
                                            <div className="d-flex align-items-center gap-2">
                                                ...
                                                <div className="d-flex flex-column">
                                                    <span className="fw-bold" style={{ fontSize: 'var(--font-size-xs)', color: 'var(--text-primary)' }}>
                                                    ...
                                                    <div className="row g-3">
                                                        {/* Full Description */}
                                                         <div className="col-12">
                                                            <div style={{ fontSize: 'var(--font-size-xs)', fontWeight: 600, color: 'var(--color-text-muted)', marginBottom: '4px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Description</div>
                                                            <div style={{ fontSize: 'var(--font-size-sm)', color: 'var(--color-text-secondary)' }}>
                                                                {data.description || 'No description provided'}
                                                            </div>
                                                            {(data.aiReason || data.aiReasoning) && (
                                                                <div className="mt-2 p-2 rounded" style={{ backgroundColor: '#F0F9FF', border: '1px solid #BAE6FD', fontSize: 'var(--font-size-sm)' }}>
                                                        ...
                                                        <div className="col-md-6">
                                                            <div style={{ fontSize: 'var(--font-size-xs)', fontWeight: 600, color: 'var(--color-text-muted)', marginBottom: '4px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Seller & ASINs</div>
                                                        ...
                                                        {/* Timeline */}
                                                        <div className="col-md-6">
                                                            <div style={{ fontSize: 'var(--font-size-xs)', fontWeight: 600, color: 'var(--color-text-muted)', marginBottom: '4px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Timeline</div>
                                                        ...
                                                        {/* Last Activity */}
                                                        <div className="col-12">
                                                            <div style={{ fontSize: 'var(--font-size-xs)', fontWeight: 600, color: 'var(--color-text-muted)', marginBottom: '4px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Last Activity</div>
                                                            <div style={{ fontSize: 'var(--font-size-sm)', color: 'var(--color-text-secondary)' }}>
                                                                {data.updatedAt ? (
                ...
                {filteredObjectives.length === 0 && (
                    <div className="text-center py-5 text-muted">
                        ...
                        <div style={{ fontSize: 'var(--font-size-sm)' }}>No items found matching the current filters.</div>
                    </div>
                )}
            </div>
        );
        ...
        return (
            <div className="smartsheet-container mt-4">
                            ...
                            <tr key={action._id || action.id}>
                                ...
                                <td>
                                    <div className="d-flex align-items-center gap-2">
                                        ...
                                        <div className="d-flex flex-column">
                                            <span className="small fw-bold" style={{ fontSize: '10px', color: 'var(--text-secondary)' }}>
                ...
                {filtered.length === 0 && (
                    <div className="text-center py-5 text-muted">
                        <Filter className="mb-2 opacity-25" size={32} />
                        <div style={{ fontSize: 'var(--font-size-sm)' }}>No tasks found matching the current filters.</div>
                    </div>
                )}
            </div>
        );
    ...
    const renderFilters = () => {
        return (
            <div style={{ display: 'flex', gap: 12, alignItems: 'center', marginBottom: 16, flexWrap: 'wrap' }}>
                <div style={{ fontSize: 'var(--font-size-xs)', fontWeight: 750, color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                    Refine Registry:
                </div>
                <select
                    value={filterStatus}
                    ...
                    style={{ borderRadius: 'var(--radius-md)', height: '32px', width: '150px', fontSize: 'var(--font-size-xs)', fontWeight: 600, color: '#334155', padding: '2px 8px' }}
                >
